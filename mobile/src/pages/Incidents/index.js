...
export default function Incidents () {
    ...
    // Enviando o usuário para outra tela
    ...
    // o useEffect dispara uma função assim que o valor do array passado como 2 param mudar
    useEffect(() => {
        loadIncidents()
    },[])
    ...
    return ( 
        <View style={styles.container} >
            ...
            <FlatList  
                ...
                )} /* Função responsável por renderizar os itens (JSX) */
            />
        </View>
    )
}